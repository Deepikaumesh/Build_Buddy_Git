...
if ($connection->connect_error) {
 ...
 $file_tmp =$_FILES['image']['tmp_name'];
  ...
  //$file_name2="http://192.168.29.64/internship_crud/image_uploaded/".$file_name1;
 ...
 $sql = "INSERT INTO `contract_worker`( `id`,`name`,`place`,`phone`,`email`,`qualification`,`work`,`image`) VALUES 
 ( '$id',' $name ','$place','$phone',' $email ','$qualification','$work','$file_name2')";
