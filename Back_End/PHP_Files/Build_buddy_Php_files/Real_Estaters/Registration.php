...
and !empty($_POST["report_status"])	
	...
	$findexist="select * from   real_estaters where username='".$username."'";
	...
	echo json_encode($result);
		...
		$sql="INSERT INTO  real_estaters(username,email,phone,password,report_status)values('".$username."','".$email."','".$phone."','".$password."','".$report_status."')";
