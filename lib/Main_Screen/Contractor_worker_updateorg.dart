...
//
//   // final Contracter_worker_Update_model data_user;
//
//   Contractor_worker_update({required this.data_user});
//
//   @override
//   _Contractor_worker_updateState createState() => _Contractor_worker_updateState();
// }
//
...
//     final uri = Uri.parse(
//         "http://$ip_address/Build_buddy_Php_files/Contracters/Update_COntracters_workers_profile.php");
...
//     qualification = TextEditingController(text: widget.data_user.qualification);
//     work=TextEditingController(text: widget.data_user.work);
//
//
//
//
