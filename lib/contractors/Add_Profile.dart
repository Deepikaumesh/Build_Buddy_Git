...
class Add_Profile extends StatefulWidget {
  @override
  _Add_ProfileState createState() => _Add_ProfileState();
}

class _Add_ProfileState extends State<Add_Profile> {
  var _image;
//  final picker = ImagePicker();
  ...
  Future uploadImage() async {
    final uri = Uri.parse(
        ...
        "http://$ip_address/Build_buddy_Php_files/Contracters/add_profile.php");
