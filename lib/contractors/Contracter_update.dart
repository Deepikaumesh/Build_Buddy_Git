...
class Contracter_Update extends StatefulWidget {
  final Contracter_profile_model data_user;

  Contracter_Update({required this.data_user});

  @override
  _Contracter_UpdateState createState() => _Contracter_UpdateState();
}

class _Contracter_UpdateState extends State<Contracter_Update> {
  var _image;
...
TextButton(onPressed: (){
  setState(() {
    delrecord(widget.data_user.id.toString());
