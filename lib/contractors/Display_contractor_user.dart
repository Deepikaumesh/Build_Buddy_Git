...
//Applying get request.
  ...
  Future<List<Contractor_user_model>> getRequest() async {
    //replace your restFull API here.
    String url = "http://$ip_address/Build_buddy_Php_files/Contracters/Display__users_profile.php";
    ...
    //Creating a list to store input data;
    List<Contractor_user_model> users = [];
    for (var singleUser in responseData) {
      Contractor_user_model user = Contractor_user_model(
        //id:  singleUser["id"].toString(),
        id: singleUser["id"].toString(),
