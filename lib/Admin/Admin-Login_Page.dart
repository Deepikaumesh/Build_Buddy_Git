...
class AdminLogin_Page extends StatefulWidget {
  const AdminLogin_Page({Key? key}) : super(key: key);

  @override
  _AdminLogin_PageState createState() => _AdminLogin_PageState();
}

class _AdminLogin_PageState extends State<AdminLogin_Page> {
  ...
  Future admin_Login() async {
    var url = "http://$ip_address/Build_buddy_Php_files/Admin/Login.php";
