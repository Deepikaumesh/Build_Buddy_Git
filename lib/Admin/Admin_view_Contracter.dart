...
class Admin_View_Contracter extends StatefulWidget {
  @override
  _Admin_View_ContracterState createState() => _Admin_View_ContracterState();
}

class _Admin_View_ContracterState extends State<Admin_View_Contracter> {
//Applying get request.

  Future<List<Contracter_model>> getRequest() async {
    ...
    List<Contracter_model> users = [];
    for (var singleUser in responseData) {
      Contracter_model user = Contracter_model(
