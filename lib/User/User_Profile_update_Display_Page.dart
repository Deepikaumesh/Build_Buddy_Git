...
class User_Profile_update_Display_Page extends StatefulWidget {
  // final user_mode data_user;
  //
  // Contractor_worker_update_Display_Page({required this.data_user});

  @override
  _User_Profile_update_Display_PageState createState() =>
      _User_Profile_update_Display_PageState();
}

class _User_Profile_update_Display_PageState extends State<User_Profile_update_Display_Page> {
                  ...
                  return Column(
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            setState(() {
Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>User_Profile_update(data_user: snapshot.data![index],)));
                            });
                            // updateImage();
  ...
  Future<List<user_mode>> getRequest() async {
    //replace your restFull API here.
    String url =
        "http://$ip_address/Build_buddy_Php_files/Users/Dispay_user_profile.php?id="+id_user;
