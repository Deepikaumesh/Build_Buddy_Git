...
class User_Profile_update extends StatefulWidget {
  final user_mode data_user;

  User_Profile_update({required this.data_user});

  @override
  _User_Profile_updateState createState() =>
      _User_Profile_updateState();
}

class _User_Profile_updateState extends State<User_Profile_update> {
  ...
  submit() async {
    final response = await http.post(
        Uri.parse(
            "http://$ip_address/Build_buddy_Php_files/Users/Update_user+profile.php"),
        body: {
    ...
    if (response.statusCode == 200) {
      ...
      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>User_Profile_update_Display_Page()));
    } else {
      print("not");
      final snackBar = await SnackBar(
